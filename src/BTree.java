...
public class BTree {
    ...
    int m;//nivel del arbol
    BNode root;//objeto nodo raiz
    ...
    //metodo para añadir claves y determina si las claves ya existían en el árbol
    public void add( int n ){
        if( find(n) ){
            System.out.println("La clave ya existe en el árbol.");
        }
        else{
            //metodo para añadir nuevos nodos hoja al árbol
            BNode hoja = leafNode( root, n );
            addToNode( hoja, n);
        }
    
    }
    //metodo que revisa si el nodo es un nodo hoja
    ...
    //metodo para monitorear si la capacidad de los nodos no se ha alcanzado
    ...
    //metodo para ingresar la clave en el nodo correspondiente
    ...
    //metodo para repartir los valores del nodo desbordado en nuevos nodos 
    ...
    //Metodo para imprimir los valores del árbol de acuerdo a los nodos 
    ...
    //Función para buscar un elemento de acuerdo a un valor
   ...
   //función para buscar un elemento de acuerdo a un valor y a un nodo específico
